...
class WarmupStableDecay:
    ...
    def __init__(
        ...
        max_lr: float = 1.0,  # Added max_lr argument
    ) -> None:
        self.warmup_steps = warmup_steps
        self.max_steps = max_steps
        self.warmdown_steps = warmdown_steps
        self.max_lr = max_lr  # Store the maximum learning rate
    ...
    def _wsd_linear(self, step: int) -> float:
        ...
        if step < self.warmup_steps:
            ...
            # Modify decay to 0.1 of max_lr
            return 0.1 + 0.9 * decay_ratio  # Decay to 0.1 of the maximum learning rate
    ...
    def _wsd_sqrt(self, step: int) -> float:
        ...
        if step < self.warmup_steps:
            ...
            # Modify decay to 0.1 of max_lr
            return 0.1 + 0.9 * (1 - math.sqrt(progress_into_cooldown))  # Decay to 0.1 of the maximum learning rate
