            ...
            for p in group["params"]:
                ...
                if len(state) == 0:
                    ...
                    if beta2 is not None:
                        # Low-rank variance buffer (along smaller dimension)
                ...
                if weight_decay > 0:
                    if cautious:
                        # Cautious weight decay: apply only where update and param have same sign
