...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, config, layer_idx=0):
        ...
        # 2x if dynamic mixing enabled to compensate for sigmoid
        ...
        if self.dynamic_mixing_enabled and should_have_residual_params:
            # 8 outputs for Q,K,V,G x lambda1,lambda2 (or 6 if no gating)
...
class OBPM(nn.Module):
    def __init__(self, config: ModelConfig):
        ...
        # Learnable mixture between embeddings and layer 0 output
